...
func (suite *UserServiceTestSuite) TestGetUser() {
	...
	expectedUser := &po.Users{Username: "testuser"}
...
func (suite *UserServiceTestSuite) TestGetList() {
	...
	expectedResult := &po.PageResult[*po.Users]{
		Page: &po.Page{
			Index:     1,
			Size:      10,
			TotalPage: 1,
		...
		Data: []*po.Users{{Username: "testuser1"}, {Username: "testuser2"}},
	}
...
func (suite *UserServiceTestSuite) TestCreate() {
	...
	suite.Deps.UsersRepo.On("Create", mock.Anything, mock.AnythingOfType("*po.Users")).Return(expectedId, nil).Once()
...
func (suite *UserServiceTestSuite) TestUpdate() {
	...
	suite.Deps.UsersRepo.On("Update", mock.Anything, mock.AnythingOfType("*po.Users")).Return(nil)
...
func (suite *UserServiceTestSuite) TestLogin() {
	...
	expectedUser := &po.Users{Username: "existinguser", PasswordHash: crypto.Hash("password123")}
...
func (suite *UserServiceTestSuite) TestLoginUserNotFound() {
	...
	suite.Deps.UsersRepo.On("Get", mock.Anything, mock.AnythingOfType("*request.UsersGet")).Return(nil, errors.New("user not found")).Once()
	token, err := suite.UsersService.Login(suite.ctx, loginCond)
...
func (suite *UserServiceTestSuite) TestGetByToken() {
	ctx := &gin.Context{Request: &http.Request{}}
	expectedUser := &po.Users{ID: "1", Username: "existinguser", PasswordHash: "b3b05680b7d6a00ff23159c0ee155d9c"}
	jwtTokenUuid := uuid.New()
	expectedJwtTokenClaims := &po.JWTClaims{
		User:     expectedUser,
