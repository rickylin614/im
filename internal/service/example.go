...
type IExampleService interface {
	Get(ctx *gin.Context, cond *request.ExampleGet) (*models.Example, error)
	GetList(ctx *gin.Context, cond *request.ExampleGetList) (*models.PageResult[*models.Example], error)
...
func (s exampleService) Get(ctx *gin.Context, cond *request.ExampleGet) (*models.Example, error) {
	db := s.in.DB.Session(ctx)
	return s.in.Repository.ExampleRepo.Get(db, cond)
}

func (s exampleService) GetList(ctx *gin.Context, cond *request.ExampleGetList) (*models.PageResult[*models.Example], error) {
	db := s.in.DB.Session(ctx)
