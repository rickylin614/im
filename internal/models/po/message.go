...
type Message struct {
	...
	SenderId    string              `json:"senderId" bson:"senderId"`       // 發送者的識別碼
	Recipient   string              `json:"recipient" bson:"recipient"`     // 接收者的識別碼
	RecipientId string              `json:"recipientId" bson:"recipientId"` // 接收者的識別碼
	MsgContent  string              `json:"msgContent" bson:"msgContent"`   // 訊息內容
